...
def generar_contenido_email(nombre: str, apellido: str, area: str, reporte: str) -> Dict[str, str]:
    asunto = area
    ...
    <html>
        <body>
            ...
            <p><strong>Área del Problema:</strong> {area}</p>
...
class EmailService:
    @staticmethod
    def generar_contenido_email(nombre: str, apellido: str, area: str, reporte: str) -> Dict[str, str]:
        return generar_contenido_email(nombre, apellido, area, reporte)
